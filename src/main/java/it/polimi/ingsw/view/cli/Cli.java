...
public class Cli extends Client<Scanner> {
    ...
    public void run() throws IOException {
        System.out.println("----------------------------------------------------------------------------------------------------------------------------------------------------\n" +
                           "||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||\n" +
                           "----------------------------------------------------------------------------------------------------------------------------------------------------\n" +
                           "|||||              ________          __         ___    __     __________      ________       ________      __     ___    __     __             |||||\n" +
                           "|||||             //                //\\\\        ||\\\\   ||         ||         ||      ||     ||      \\\\     ||     ||\\\\   ||     ||             |||||\n" +
                           "|||||             \\\\_______        //__\\\\       || \\\\  ||         ||         ||      ||     ||______//     ||     || \\\\  ||     ||             |||||\n" +
                           "|||||                     \\\\      //    \\\\      ||  \\\\ ||         ||         ||      ||     ||    \\\\       ||     ||  \\\\ ||     ||             |||||\n" +
                           "|||||              _______//     //      \\\\     ||   \\\\||         ||         ||______||     ||     \\\\      ||     ||   \\\\||     ||             |||||\n" +
    ...
    /**
     * This method processes a specific gameState and prints the associated message.
     *
     * @param state is a GameState
     */
