...
public class WelcomeFirst extends JPanel {
    ...
    public WelcomeFirst() throws IOException {
        ...
        Image button2Png = ImageIO.read(new File(buttonsPath.concat("2PlayersButton.png")));
        ...
        Image button3Png = ImageIO.read(new File(buttonsPath.concat("3PlayersButton.png")));
